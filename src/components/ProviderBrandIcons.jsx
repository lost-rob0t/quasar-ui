...
const PROVIDER_BRANDS = Object.freeze({
  openrouter: { label: "OpenRouter", slug: "openrouter", fallback: "OR" },
  openai: { label: "OpenAI", slug: "openai", fallback: "OA" },
  anthropic: { label: "Anthropic", slug: "anthropic", fallback: "A" },
  local: { label: "Ollama", slug: "ollama", fallback: "OL" },
  "openai-compatible": { label: "OpenAI-compatible API", slug: null, fallback: "API" }
});
