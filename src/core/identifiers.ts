...
export class InvalidIdentifierError extends TypeError {
  ...
  constructor(value: unknown, label = "identifier") {
    super(`${label} must be 1-256 characters and contain only letters, numbers, '.', '_', ':', '/', or '-'`);
...
export function assertStableIdentifier(value: unknown, label = "identifier"): asserts value is string {
