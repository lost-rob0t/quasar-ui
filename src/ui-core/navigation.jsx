...
export const navigation = Object.freeze([
  ...
  { to: "/graph", label: "Graphs", mobileLabel: "Graph", Icon: Network, match: (path) => path === "/graph" || path.startsWith("/graph/") },
  ...
  { to: "/agents", label: "Agents", mobileLabel: "Agents", Icon: Bot, match: (path) => path === "/agents" },
  { to: "/actors", label: "Actors", Icon: Code2, match: (path) => path === "/actors" },
  { to: "/import", label: "Import", Icon: FolderInput, match: (path) => path === "/import" },
  { to: "/settings", label: "Settings", mobileLabel: "Settings", Icon: Settings, match: (path) => path === "/settings" }
]);
